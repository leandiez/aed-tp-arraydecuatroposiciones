...
\begin{tad}{Airmiles}
	...
	\vspace{0.5cm}
	\comentario{RECORDAR PONER LA CONDICION CUANDO ES PLATINO NO DEBE SUMARLA AL TOTAL}\\
	\auxLargo{MillasTotales}
	{IdUsuario : \Tipo{\Z}, Historial : \seq{Transacciones}}
	{\Tipo{\Z}}
	{res = \sum\limits_{i=0}^{\lvert Historial \rvert - 1} \IfThenElse{EsTransaccionDelUsuario(Historial[i], IdUsuario \land EsTransaccionSumadora(Historial[i], IdUsuario))}{Historial[i].Millas}{0}}
