...
\begin{tad}{Airmiles}
    ...
    \end{proc}
    \\ \\
    \comentario{Saque los y luego que no hacian falta, hice que devolviera las transacciones actualizas al TAD en el IfThenElse.}
    \\
    ...
    {historialTransacciones ++ \tupla{idUsuario,-1,2,millasCanjeadas,'NoPromo',1.0}}
    \vspace{0.5cm}
    \comentario{concatenee para que siga en orden ademas el pertenece devuelve un boolean.}
    ...
    \comentario{Este MillasDisponibles Esta mal pero no importa porque se usa el otro}
    ...
    \comentario{En la primer condicion no valido el IdUsuario porque se supone que si no es una transferencia nunca deberia venir en el campo UsuarioDestino, y ya valide que al menos esta en uno de los 2. NO SE USA}
    ...
    \comentario{Valido que el IdUsuario este en alguno de los 2 campos. Si no esta en ninguno, entonces no debo sumar ni restar nada. NO SE USA}
