...
\begin{tad}{Airmiles}
	...
	\begin{proc}{ResumenTransacciones}
		...
		\aseguraLargo{ \tupla{res}[0] = MillasObtenidasPorVuelo(AM.Transacciones, id) \\
			\land_L \tupla{res}[1] = MillasDescontadasPorCanjeo(AM.Transacciones, id) \\
			\land_L \tupla{res}[2] = MillasTransferidas(AM.Transacciones, id, id)
		}
	\end{proc}
