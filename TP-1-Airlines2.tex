...
\begin{tad}{Airmiles}
	...
	\begin{proc}{CanjearMillas}
		...
		\aseguraLargo{			
			\IfThenElse{ MillasDisponibles(IdUsuario, AM_{0}.Historial) \geq MillasCanjeadas}
			\\{EsNuevaTransaccion(AM, AM0, IdUsuario,-1, 2, \\ MillasCanjeadas, 0, NoPromo, 0},
	...
	\begin{proc}{TransferirMillas}
		...
		\requiere{AM0 = AM \land idUsuarioPagador \in claves(AM.usuarios)\\
			...
			\land MillasDisponibles(idUsuarioPagador, AM.Historial) \geq CantMillasTrans
		}
	...
	\begin{proc}{ElQueTieneMasMillas}
		...
		\aseguraLargo{			
			...
			\\
			\comentario{Devuelve millas y deberia devolver un usuario¿?}
		}
	\end{proc}
	...
	{			
		...
		\comentario{hace falta dos veces hay otro usuario¿?}\\
		\comentario{si hay otro usuario en uno de los dos, me devuelve true}
	}
	...
	{			
		...
		\comentario{Esto es siempre False o casi siempre, porque el usuario  origen en cada transaccion no es t0, 
			deberia ir antes del implica diria}
	}
