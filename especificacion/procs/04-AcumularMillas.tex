...
\begin{tad}{Airmiles}
    ...
    \begin{proc}{AcumularMillas}
        ...
        \aseguraLargo{
            ...
            \\
            \comentario{En caso de no llegar a las millas del usuario, completo con NoPromo las millas restantes}
            \\
            ...
            \\DarFactorCategoria(AM0.Historial,idUsuario), FactorPromo), distancia, "NoPromo", 1)
