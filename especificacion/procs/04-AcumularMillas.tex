...
\begin{tad}{Airmiles}
    ...
    \begin{proc}{AcumularMillas}
        ...
        \aseguraLargo{
            \comentario{Solo le aplica la promocion si tengo millas restantes en la promo, si no no. ¿ Y si no ?}
            \\
            AM0.Promociones\lbrack nombrePromo \rbrack.millasRestantes \geq distancia \implica
            \\
            EsNuevaTransaccion(AM,AM0,idUsuario,-1,0,
            \\
            millasCalculadas(distancia,DarFactorCategoria(AM0.Historial
            \\
            ,idUsuario),
    ...
    \auxLargo{EsVuelo}
        {Transaccion: \Tipo{Transacciones}, idOrigen: \Tipo{\Z}}
        {\Tipo{bool}}
        {
    ...
    \auxLargo{EsTransferencia}
        {Transaccion: \Tipo{Transacciones}, idOrigen: \Tipo{\Z}, idDestino: \Tipo{\Z}}
        {\Tipo{bool}}
        {
            Transaccion.UsuarioOrigen = idOrigen \land
            \\
    ...
    {Historial: \Tipo{Transacciones}, idOrigen: \Tipo{\Z}, idDestino: \Tipo{\Z}}
    {\Tipo{\R}}
    {
    ...
    {\Tipo{\R}}
    {
        MillasTotales(Historial, idOrigen) -
        \\ 
        MillasDescontadasPorCanjeo(Historial,idOrigen) -
        \\ 
        \comentario{en este orden son las que transferi (descontadas)}
        \\
        MillasTransferidas(Historial, idOrigen, idDestino)
    }
